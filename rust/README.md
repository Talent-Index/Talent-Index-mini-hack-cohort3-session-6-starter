...
| `src/bin/payment_agent.rs` | Session 6: the invoice payment agent, evaluates a condition, gets human approval, sends real USDC on Fuji, includes real `#[cfg(test)]` tests |
